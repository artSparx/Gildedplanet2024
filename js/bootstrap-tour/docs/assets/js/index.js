    ...
    tour.addSteps([
      {
        ...
        content: "Introduce new users to your product by walking them through it step by step. Built" + "on the awesome <a href='https://twitter.github.com/bootstrap' target='_blank'>Bootstrap " + "from Twitter.</a>"
      }, {
        element: "#usage",
        placement: "top",
